...
# Infection threshold back-transformed to raw fluorescence scale
raw_threshold <- 10^(L_p_val + threshold_final * (H_p_val - L_p_val))
...
print(p_ridgeline)
ggsave("Plots/compound_ridgeline.tiff", p_ridgeline, width = 5.5, height = 4.5, units = "in", dpi = 300, compression = "lzw", device = ragg::agg_tiff)
```
