...
End-to-end DESeq2 workflow from counts or SummarizedExperiment inputs, with QC, DE plots, heatmaps, and reusable exports.
...
Use this searchable table as a quick reference for the available analyses, methods, and output types.
...
templates <- data.frame(
  ...
  `Key Statistics` = c(
    ...
    "DESeq2, QC diagnostics, heatmaps, viral module",
  ...
  `Key Plot Types` = c(
    ...
    "Volcano, MA, PCA, heatmap, bubble, triangle",
