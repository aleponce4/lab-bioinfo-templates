...
res_lm <- dat_long %>%
  ...
  mutate(
    effect = recode(term,
      "(Intercept)"                                          = "Intercept",
      paste0("Factor1", FACTOR1_LEVELS[2])                  = paste0(FACTOR1_LEVELS[2], " vs ", FACTOR1_LEVELS[1]),
      paste0("Factor2", FACTOR2_LEVELS[2])                  = paste0(FACTOR2_LEVELS[2], " vs ", FACTOR2_LEVELS[1]),
      paste0("Factor1", FACTOR1_LEVELS[2], ":Factor2", FACTOR2_LEVELS[2]) = "Interaction"
    ),
