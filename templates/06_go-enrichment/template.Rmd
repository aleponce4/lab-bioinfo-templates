...
cat('<div id="bubble-carousel" class="carousel slide" data-bs-interval="false" style="background:#f8f8f8;border-radius:6px;padding:10px;">\n')
...
if (length(go_comps) > 1) {
  ...
  cat('<div id="go-carousel" class="carousel slide go-carousel" data-bs-interval="false" style="background:#f8f8f8;border-radius:6px;padding:10px;">\n')
  cat('  <div class="carousel-indicators">\n')
...
if (length(kegg_comps) > 1) {
  cat('<div id="kegg-carousel" class="carousel slide go-carousel" data-bs-interval="false" style="background:#f8f8f8;border-radius:6px;padding:10px;">\n')
  cat('  <div class="carousel-indicators">\n')
