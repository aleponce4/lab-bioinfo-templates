...
if (length(bubble_names) > 1) {
  ...
  for (i in seq_along(bubble_names)) {
    ...
    cat(sprintf('    <div class="carousel-item%s">\n      <img src="%s" class="d-block w-100" alt="%s" style="background:white;border-radius:4px;">\n    </div>\n',
      active, img_src, nm))
  }
  cat('  </div>\n')
  cat('  <button class="carousel-control-prev" type="button" data-bs-target="#bubble-carousel" data-bs-slide="prev">\n    <span class="carousel-control-prev-icon" style="background-color:rgba(0,0,0,0.5);border-radius:50%%;padding:18px;"></span>\n  </button>\n')
  cat('  <button class="carousel-control-next" type="button" data-bs-target="#bubble-carousel" data-bs-slide="next">\n    <span class="carousel-control-next-icon" style="background-color:rgba(0,0,0,0.5);border-radius:50%%;padding:18px;"></span>\n  </button>\n')
  cat('</div>\n')
...
if (length(triangle_names) > 1) {
  cat('<div id="tri-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false" style="background:#f8f8f8;border-radius:6px;padding:10px;">\n')
  cat('  <div class="carousel-indicators">\n')
  for (i in seq_along(triangle_names)) {
    active <- if(i == 1) ' class="active" aria-current="true"' else ''
    cat(sprintf('    <button type="button" data-bs-target="#tri-carousel" data-bs-slide-to="%d"%s></button>\n', i-1, active))
  }
  cat('  </div>\n  <div class="carousel-inner">\n')
  for (i in seq_along(triangle_names)) {
    nm <- triangle_names[i]
  ...
  cat('  </div>\n')
  cat('  <button class="carousel-control-prev" type="button" data-bs-target="#tri-carousel" data-bs-slide="prev">\n    <span class="carousel-control-prev-icon" style="background-color:rgba(0,0,0,0.5);border-radius:50%%;padding:18px;"></span>\n  </button>\n')
  cat('  <button class="carousel-control-next" type="button" data-bs-target="#tri-carousel" data-bs-slide="next">\n    <span class="carousel-control-next-icon" style="background-color:rgba(0,0,0,0.5);border-radius:50%%;padding:18px;"></span>\n  </button>\n')
  cat('</div>\n')
