...
# Bubble Plots {.tabset .tabset-fade}

```{r bubble-tabset, fig.width=8, fig.height=9, message=FALSE, warning=FALSE, results='asis', echo=FALSE}
...
# Triangle Plots {.tabset .tabset-fade}

```{r triangle-tabset, fig.width=6, fig.height=9, message=FALSE, warning=FALSE, results='asis', echo=FALSE}
for (pathway_name in names(GENE_SETS)) {
  cat("\n### ", pathway_name, " {}\n\n", sep = "")
