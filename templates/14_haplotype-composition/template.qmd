...
| **Download** | [template.qmd (GitHub)](https://github.com/aleponce4/lab-bioinfo-templates/blob/main/templates/14_haplotype-composition/template.qmd) |
...
[Download .qmd](https://github.com/aleponce4/lab-bioinfo-templates/blob/main/templates/14_haplotype-composition/template.qmd){.btn .btn-primary}
...
bar_info = list(zip(sample_meta["route"].astype(str), sample_meta["dpi"].astype(int)))
